...
public class EchoResponse {
    ...
    private String uri;
    private CaseInsensitiveStringMultiMap headers = new CaseInsensitiveStringMultiMap();
     ...
     * @return the headers
     */
    public CaseInsensitiveStringMultiMap getHeaders() {
        return headers;
    }
     ...
     */
    public void setHeaders(CaseInsensitiveStringMultiMap headers) {
